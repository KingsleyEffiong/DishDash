    ...
    return (
        <div className=''>
            ...
            <rect x="82.5" width="65" height="12" rx="6" fill="#FD5D69"/>
                ...
                <h1 className="font-bold text-2xl">Select your cuisines preferences</h1>
            ...
            <div className="">
                <Button onClick={() => navigate("/alligies")} className="bg-[var(--pink)] w-44 text-[var(--pink-sup-color)] h-auto px-6 py-3 rounded-full m-5">Skip</Button>

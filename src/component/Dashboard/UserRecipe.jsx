...
function UserRecipe() {
    ...
    // })
    return (
        <div className="w-fit h-auto bg-[var(--red-pink-main)] mt-7 rounded-xl p-2">
           <h1>Your Recipe</h1>
           <div className="flex flex-row gap-2 ">
                <div className="relative w-[180px] overflow-hidden h-auto">
                <img className="rounded-xl w-[180px] " src="/images/ceviche-bowl-black-table 1.png" alt="" />
                <div className="absolute bottom-0 left-0 shadow-md  w-[150px] h-[48px] bg-white rounded-lg px-2">
                    <h2 className="text-black">Chicken Burger</h2>
                    <div className="flex flex-row justify-around">
                    <div className="flex flex-row items-center gap-1 w-14">
                    <span className="text-xs text-[var(--pink-sup-color)]">5</span>
            ...
            <span className="text-xs text-[var(--pink-sup-color)]">30min</span>
                </div>
                </div>
                    </div>
                </div>
                <div className="relative w-auto h-auto">
                <img className="rounded-xl" src="/images/ceviche-bowl-black-table 1(1).png" alt="" />
                <div className="absolute bottom-0 left-0 shadow-md  w-[150px] h-[48px] bg-white rounded-lg px-2">
                    <h2 className="text-black">Tiramisu</h2>
                    <div className="flex flex-row justify-around">
                    <div className="flex flex-row items-center gap-1 w-14">
                    <span className="text-xs text-[var(--pink-sup-color)]">5</span>
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
